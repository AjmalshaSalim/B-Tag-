            ...
            {cardData.map((card, index) => (
              <SwiperSlide key={index}    onClick={() => handleCardClick(card.id)}>
                ...
                <div className='p-4 mx-auto w-[300px] h-[520px] '>
                        ...
                        <p className='font_poppins font-semibold text-[19px] mt-4 leading-7'>{card.title}</p>
    
                        <p className='font_poppins text-[#4D4A4A] text-[17px] absolute bottom-[178px]'><LocationOnIcon className='text-[#578d01] font-medium'/>{card.location}</p>
    
                        <p className='text-[14px] w-[270px] text-justify text-[#505050] mt-2 font_poppins font-normal  leading-5 absolute bottom-[88px]'>{truncateText(card.introduction, 24)}</p>
