      ...
      <div className='w-full bg-white text-center py-10 md:py-16 md:mb-11'>
        ...
        <form className='lg:w-[645px] w-[320px] mx-auto'>
                  ...
                  <div className=' flex gap-3'>
                    <input className='lg:w-[317px] w-[320px] bg-[#F2F2F2] rounded-xl p-5 mb-4 font_poppins outline-0' type="email" placeholder='Your Email'  name="" id="" />
  
                    <input className='lg:w-[317px] w-[320px] bg-[#F2F2F2] rounded-xl p-5 mb-4 font_poppins outline-0' type="tel" placeholder='Phone Number'  name="" id="" />
                  </div>
